<%@ Page Language="C#" MasterPageFile="~/MasterPages/Monsees.Master" AutoEventWireup="true" CodeBehind="PartHistory.aspx.cs" Inherits="Monsees._Default_History"%>
...
<asp:Content ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <table>
        <tr>
            <td>
                <asp:ListView ID="ListView1" runat="server" DataKeyNames="DetailID" EnableModelValidation="True" EnableTheming="False" OnItemDataBound="ListView1_ItemDataBound">
                        ...
                        <ItemTemplate>
                           JobID:
                            <asp:Label ID="PartLabel" runat="server" Text='<%# Eval("PartNumber") %>' />
                            <br />
                            JobNumber:
                            <asp:Label ID="DescriptionLabel" runat="server" Text='<%# Eval("DrawingNumber") %>' />
                            <br />
...
<table width="100%"><tr><td style="vertical-align:top">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" onrowcommand="GridView1_RowCommand" DataKeyNames="JobItemID, Active Version" EnableModelValidation="True" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Height="177px" >
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Inventory Qty" DataField="Inventory" SortExpression="Inventory" />
			...
			<asp:ButtonField CommandName="GetFile" Text="Drawing" ></asp:ButtonField>
            <asp:ButtonField CommandName="Inspection" Text="Report" ></asp:ButtonField>					
            <asp:ButtonField Text="Add Fixture" CommandName="AddFixt" />
            <asp:ButtonField Text="Allocate Fixture" CommandName="AllocFixt" />
...
<ControlStyle Font-Size="Small" />
        ...
        <SelectedRowStyle BackColor="#008A8C" Font-Bold="True" ForeColor="White" />
                                ...
                                <br /><b><u>Inventory:</u></b><br />
                                <asp:GridView ID="GridView10" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" GridLines="Vertical">
          <AlternatingRowStyle BackColor="#DCDCDC" />
          <Columns>
              <asp:BoundField DataField="Quantity" HeaderText="Quantity" SortExpression="Quantity" />
