...
namespace Monsees
{
    public partial class JobSummaryViewer : DataPage
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {   
                ...
                case "Clear":
                        ...
                        con.Close();
                        SqlDataSource1.SelectCommand = "SELECT [Notes], [Quantity], [IsOpen], [PartNumber], [DrawingNumber], [JobItemID], [Revision Number] AS Revision_Number, [NextDelivery], [FileType], CAST([RTS] AS Bit) AS [RTS], [MaxOfCurrDelivery], Clear, [Active Version] FROM [JobItem] WHERE Quantity > 0 And JobID = " + jobId;
                        GridView1.DataSource = SqlDataSource1;
                        GridView1.DataBind();
                        break;
