<%@ Page Language="C#" MasterPageFile="~/MasterPages/Monsees.Master" AutoEventWireup="true" CodeBehind="FixtureList.aspx.cs" Inherits="Monsees._Default_FixtureList"%>
...
<asp:BoundField DataField="Plating" HeaderText="Plating" SortExpression="Plating" ItemStyle-Width="8%">
				   <ItemStyle HorizontalAlign="Left" />
					...
					<asp:LinkButton ID="lbGetFile" runat="server" CommandName="GetFile" CommandArgument='<%#Eval("RevisionID") %>' Text="Drawing" Width="6%"></asp:LinkButton>
				   	...
				   	<asp:TemplateField>
						<ItemTemplate>
							<a href="/FixturetoParts.aspx?id=<%#Eval("RevisionID")%>">Allocate to Part(s)</a>
						</ItemTemplate>
					</asp:TemplateField>
