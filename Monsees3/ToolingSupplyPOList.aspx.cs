...
namespace Monsees
{
    public partial class _Default_ToolingSupplyOrders : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MonseesConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
                ...
                if (DescFilter.Text != "")
                {
                    ...
                    {
                        toggle = true;
                        query.Append(" WHERE  Description LIKE '%" + DescFilter.Text + "%'");
                    }
                    else query.Append(" And  Description LIKE '%" + DescFilter.Text + "%'");
                }
                query.Append(" ORDER BY SuppliesPOItemID DESC");
